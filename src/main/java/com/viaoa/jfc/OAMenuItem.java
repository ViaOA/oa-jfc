...
public class OAMenuItem extends JMenuItem implements OAJfcComponent {
	...
	public static final ButtonEnabledMode UsesIsEnabled = ButtonEnabledMode.UsesIsEnabled;
	public static final ButtonEnabledMode Always = ButtonEnabledMode.Always;
	public static final ButtonEnabledMode ActiveObjectNotNull = ButtonEnabledMode.ActiveObjectNotNull;
	public static final ButtonEnabledMode ActiveObjectNull = ButtonEnabledMode.ActiveObjectNull;
	public static final ButtonEnabledMode HubIsValid = ButtonEnabledMode.HubIsValid;
	public static final ButtonEnabledMode HubIsNotEmpty = ButtonEnabledMode.HubIsNotEmpty;
	public static final ButtonEnabledMode HubIsEmpty = ButtonEnabledMode.HubIsEmpty;
	public static final ButtonEnabledMode AOPropertyIsNotEmpty = ButtonEnabledMode.AOPropertyIsNotEmpty;
	public static final ButtonEnabledMode AOPropertyIsEmpty = ButtonEnabledMode.AOPropertyIsEmpty;
	public static final ButtonEnabledMode SelectHubIsNotEmpty = ButtonEnabledMode.SelectHubIsNotEmpty;
	public static final ButtonEnabledMode SelectHubIsEmpty = ButtonEnabledMode.SelectHubIsEmpty;
	...
	public OAMenuItem(Hub hub, String text, Icon icon, ButtonEnabledMode enabledMode, ButtonCommand command) {
		...
		if (command == ButtonCommand.GoTo) {
			...
			control = new OAMenuItemController(hub, OAButton.ButtonEnabledMode.HubIsValid, command, HubChangeListener.Type.HubValid, true,
					true);
			...
			control = new OAMenuItemController(hub, OAButton.ButtonEnabledMode.ActiveObjectNotNull, command,
					HubChangeListener.Type.AoNotNull, true, true);
	...
	/**
	 * Built in command. Set command value and set button text, tooltip, and icon. public void setCommand(ButtonCommand command) { if
	 * (command == ButtonCommand.NewManual) { control.setCommand(ButtonCommand.Add); setManual(true); } control.setCommand(command); }
	 */
	...
	*/
	...
	/**
	 * Bind menuItem to automatically work with a Hub and command. public void bind(Hub hub, ButtonCommand command) { setHub(hub);
	 * setCommand(command); }
	 */

	/**
	 * Bind menuItem to automatically work with a Hub. This will setAnyTime(false); public void bind(Hub hub) { setHub(hub);
	 * setCommand(null); }
	 */
	...
	class OAMenuItemController extends ButtonController {
		public OAMenuItemController(Hub hub, OAButton.ButtonEnabledMode enabledMode, OAButton.ButtonCommand command,
