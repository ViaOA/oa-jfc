 ...
 * automatically. This component will automatically size the font to take up all avail space. It uses Font.BOLD as a style.
 * <p>
 * Example:<br>
...
public class OADateChooser extends JPanel implements OAJfcComponent {
	...
	public Dimension getPreferredSize() {
		if (dimPreferred == null) {
			...
			Insets inset;
			if (border != null) {
				inset = border.getBorderInsets(this);
			} else {
	...
	public void paintComponent(Graphics graphics) {
		...
		if (fontSize > 10) {
			g.drawLine(0, y + 2 + extraY, dim.width, y + 2 + extraY);
		}
