...
/**
 * PopupMenu that will bind button(s) to control open and close of a component that is within the popup. Used to add a popup/dropdown to a
 * button.
 * <p>
 * Example:<br>
...
public class OAPopup extends JPopupMenu {
	 ...
	 * @param cmdOpen        component that causes popup to be displayed. Popup will be display under this component.
	 */
	...
	public void addCloseCommand(JComponent component) {
		setupCloseListener(component);
	}
		...
		*/
		component.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				if (!bShowing) {
					if (bRightClick && !e.isPopupTrigger()) {
						return;
					}
