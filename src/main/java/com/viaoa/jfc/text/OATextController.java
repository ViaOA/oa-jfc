...
public class OATextController {
	...
	protected void updateEnabled() {
		...
		if (miFind != null) {
			miFind.setEnabled(true);
		}
		if (pmiFind != null) {
			pmiFind.setEnabled(true);
		}
		if (cmdFind != null) {
		...
		if (pmiReplace != null) {
			pmiReplace.setEnabled(b);
		}

		if (miSpellCheck != null) {
			miSpellCheck.setEnabled(b);
		}
		if (pmiSpellCheck != null) {
			pmiSpellCheck.setEnabled(b);
		}
		if (cmdSpellCheck != null) {
			cmdSpellCheck.setEnabled(b);
		}
		...
		if (editor != null) {
			...
			if (cmdCut != null) {
				cmdCut.setEnabled((p != p2) && b);
			}
			if (cmdCopy != null) {
				cmdCopy.setEnabled((p != p2));
			}
		}
		...
		if (cmdCopy != null) {
			cmdCopy.setEnabled(b && objx != null);
		}
		...
		if (miUnselect != null) {
			miUnselect.setEnabled(true);
		}
		if (pmiUnselect != null) {
			pmiUnselect.setEnabled(true);
		}
		if (cmdUnselect != null) {
			cmdUnselect.setEnabled(true);
		}

		if (miAutoComplete != null) {
			miAutoComplete.setEnabled(b);
		}
		if (pmiAutoComplete != null) {
			pmiAutoComplete.setEnabled(b);
		}
		if (cmdAutoComplete != null) {
			cmdAutoComplete.setEnabled(b);
		}

		if (!b && dlgFind == null) {
			Window w = getWindow();
			if (w != null) {
				dlgFind = new FindDialog(w, editor);
			}
		}
		if (dlgFind != null) {
	...
	**********************************/
	...
	public void onFind() {
		if (dlgFind == null) {
			dlgFind = new FindDialog(getWindow(), editor);
		}
	...
	public void onSpellCheck() {
		if (spellChecker == null) {
			...
			if (editor != null) {
				spellChecker.spellCheck(editor);
			}
		}
		if (editor != null) {
			editor.requestFocus(); // so that lostFocus will be called, and text will be saved
