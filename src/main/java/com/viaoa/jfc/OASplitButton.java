...
/**
 * Creates a single JButton that internally has two buttons: a main button, and a button with a down arrow. The SplitButton will manage the
 * settings and events for mainButton, and the application will need to create an actionListener to the dropDownButton. This is a subclass
 * of JButton, since toolbars have methods that work with buttons. ex: toolbar.setRollOver()
 * 
 * @author vvia
 */
public class OASplitButton extends JButton {
	...
	public String getText() {
		if (mainButton == null || bIsInSuperPaint) {
			return null;
		}
