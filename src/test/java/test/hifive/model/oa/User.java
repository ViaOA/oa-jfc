...
@OAClass(shortName = "use", displayName = "User", isLookup = true, isPreSelect = true, displayProperty = "fullName")
...
public class User extends OAObject {
	...
	@OAProperty(maxLength = 50, displayLength = 15, columnLength = 10, isSHAHash = true)
	...
	@OAMany(displayName = "Approved Points Requests", toClass = PointsRequest.class, reverseName = PointsRequest.P_ApprovingUser)
